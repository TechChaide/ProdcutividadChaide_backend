...
module.exports = {
  ...
  createOrUpdate: function () {
    var _createOrUpdate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
      var _req$body, codigo_departamento, nombre_departamento, estado, usuario_modificacion, fecha_modificacion, see, newRecord, response, record, now, offset, localDate, _response, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            _req$body = req.body, codigo_departamento = _req$body.codigo_departamento, nombre_departamento = _req$body.nombre_departamento, estado = _req$body.estado, usuario_modificacion = _req$body.usuario_modificacion, fecha_modificacion = _req$body.fecha_modificacion, see = _req$body.see; // Validar campos obligatorios
          ...
          case 2:
            ...
            _context.n = 3;
            return Departamento.findByPk(newRecord.codigo_departamento, {
              include: []
            });
          case 3:
            response = _context.v;
          ...
          case 4:
            _context.n = 5;
            return Departamento.findByPk(codigo_departamento, {
              include: []
            });
          case 5:
            record = _context.v;
          ...
          case 6:
            ...
            record.nombre_departamento = nombre_departamento !== null && nombre_departamento !== void 0 ? nombre_departamento : record.nombre_departamento;
            ...
            record.see = see !== null && see !== void 0 ? see : record.see;
            now = new Date();
          ...
          case 7:
            _context.n = 8;
            return Departamento.findByPk(record.codigo_departamento, {
              include: []
            });
          case 8:
