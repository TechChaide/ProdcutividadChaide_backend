...
var _require = require("../models"),
  Orden_empleado = _require.Orden_empleado;
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            ...
            _context.n = 2;
            return db.sequelize.query("EXEC [".concat(process.env.DB_NAME2, "].[dbo].[sp_InsertarOrdenEmpleado] :NUM_ORDEN, :CODIGO_EMP, :UNIDADES_PROD, :TURNO, :CENTRO, :CODIGO, :MAQUINA"), {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            ...
            id = req.params.id;
            _context3.n = 1;
            return Orden_empleado.findByPk(id, {
              include: []
            });
          case 1:
            record = _context3.v;
