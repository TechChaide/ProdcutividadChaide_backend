...
var _require = require("../models"),
  Orden_empleado_decimal = _require.Orden_empleado_decimal;
var _require2 = require("../helpers/error.helper"),
  handleError = _require2.handleError;
var _require3 = require("date-fns"),
  format = _require3.format; // <-- ¡AÑADE ESTA LÍNEA!
var _require4 = require("sequelize"),
  QueryTypes = _require4.QueryTypes;
var db = require("../models");
var determinarTurnoConciso = function determinarTurnoConciso(horaString) {
  var hora = parseInt(horaString.substring(0, 2), 10);
...
module.exports = {
  ...
  createOrUpdate: function () {
    var _createOrUpdate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
      var _req$body, ID, NUM_ORDEN, CODIGO_EMP, UNIDADES_PROD, FECHA, HORA, TURNO, CENTRO, CODIGO, MAQUINA, newRecord, response, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            _req$body = req.body, ID = _req$body.ID, NUM_ORDEN = _req$body.NUM_ORDEN, CODIGO_EMP = _req$body.CODIGO_EMP, UNIDADES_PROD = _req$body.UNIDADES_PROD, FECHA = _req$body.FECHA, HORA = _req$body.HORA, TURNO = _req$body.TURNO, CENTRO = _req$body.CENTRO, CODIGO = _req$body.CODIGO, MAQUINA = _req$body.MAQUINA; // Validar campos obligatorios
            ...
            return _context.a(2, res.status(400).json({
              ...
              details: {
                ID: ID === undefined ? "undefined" : ID === null ? "null" : "present"
              }
            }));
          case 1:
            if (!(ID == 0)) {
            ...
            _context.n = 2;
            return db.sequelize.query("EXEC [".concat(process.env.DB_NAME2, "].[dbo].[sp_InsertarOrdenEmpleadoDecimal] :NUM_ORDEN, :CODIGO_EMP, :UNIDADES_PROD, :TURNO, :CENTRO, :CODIGO, :MAQUINA"), {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            _context2.p = 0;
            _context2.n = 1;
            return Orden_empleado_decimal.findAll({
              include: [],
              order: [["ID", "ASC"]]
            });
          case 1:
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            ...
            id = req.params.id;
            _context3.n = 1;
            return Orden_empleado_decimal.findByPk(id, {
              include: []
            });
          case 1:
            record = _context3.v;
