...
module.exports = {
  ...
  createOrUpdate: function () {
    var _createOrUpdate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
      var _req$body, codigo_linea, nombre_linea, estado, usuario_modificacion, fecha_modificacion, newRecord, response, record, now, offset, localDate, _response, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            _req$body = req.body, codigo_linea = _req$body.codigo_linea, nombre_linea = _req$body.nombre_linea, estado = _req$body.estado, usuario_modificacion = _req$body.usuario_modificacion, fecha_modificacion = _req$body.fecha_modificacion; // Validar campos obligatorios
          ...
          case 2:
            ...
            _context.n = 3;
            return Linea.findByPk(newRecord.codigo_linea, {
              include: []
            });
          case 3:
            response = _context.v;
          ...
          case 4:
            _context.n = 5;
            return Linea.findByPk(codigo_linea, {
              include: []
            });
          case 5:
            record = _context.v;
          ...
          case 6:
            ...
            record.nombre_linea = nombre_linea !== null && nombre_linea !== void 0 ? nombre_linea : record.nombre_linea;
          ...
          case 7:
            _context.n = 8;
            return Linea.findByPk(record.codigo_linea, {
              include: []
            });
          case 8:
