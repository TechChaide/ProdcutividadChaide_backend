...
var _require = require("../models"),
  Log_reimpresiones = _require.Log_reimpresiones;
...
module.exports = {
  ...
  createOrUpdate: function () {
    var _createOrUpdate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
      var _req$body, codigo_log, orden, paquete, fecha, parametros, estado, usuario_reimpresion, newRecord, response, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            _req$body = req.body, codigo_log = _req$body.codigo_log, orden = _req$body.orden, paquete = _req$body.paquete, fecha = _req$body.fecha, parametros = _req$body.parametros, estado = _req$body.estado, usuario_reimpresion = _req$body.usuario_reimpresion; // Validar campos obligatorios
          ...
          case 1:
            ...
            _context.n = 2;
            return db.sequelize.query("EXEC [".concat(process.env.DB_NAME, "].[dbo].[sp_logReimpresion] :orden, :paquete, :parametros, :estado, :usuario_reimpresion"), {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            _context2.p = 0;
            _context2.n = 1;
            return Log_reimpresiones.findAll({
              where: {
                estado: "A"
              },
              include: [],
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            ...
            id = req.params.id;
            _context3.n = 1;
            return Log_reimpresiones.findByPk(id, {
              include: []
            });
          case 1:
            record = _context3.v;
  ...
  getByNumeroOrden: function () {
    var _getByNumeroOrden = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
      var numero_orden, records, _t4;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.p = _context4.n) {
          case 0:
            _context4.p = 0;
            numero_orden = req.body.numero_orden; // Validar que numero_orden esté presente y no sea undefined/null
            if (numero_orden) {
              _context4.n = 1;
              break;
            }
            return _context4.a(2, res.status(400).json({
              ...
              details: {
                numero_orden: numero_orden === undefined ? "undefined" : numero_orden === null ? "null" : "empty"
              }
            }));
          case 1:
            _context4.n = 2;
          ...
          case 3:
            _context4.p = 3;
            _t4 = _context4.v;
            handleError(res, _t4, "Error getting records by numero_orden");
          case 4:
            return _context4.a(2);
        }
      }, _callee4, null, [[0, 3]]);
    }));
    function getByNumeroOrden(_x7, _x8) {
      return _getByNumeroOrden.apply(this, arguments);
    }
    return getByNumeroOrden;
  }(),
  ...
  getByCodigoBarras: function () {
    var _getByCodigoBarras = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(req, res) {
      var codigo_barras, resultados, _t6;
        ...
        while (1) switch (_context6.p = _context6.n) {
          case 0:
            ...
            return _context6.a(2, res.status(400).json({
              ...
              details: {
                codigo_barras: codigo_barras === undefined ? "undefined" : codigo_barras === null ? "null" : "empty"
              }
            }));
          case 1:
            _context6.n = 2;
            return db.sequelize.query("EXEC [Etiquetas].[dbo].[sp_ConsultarLogRE_ImpresionPorCodigoBarras] :CodigoBarras", {
              // Se usan replacements para evitar inyección SQL
              replacements: {
          ...
          case 3:
            _context6.p = 3;
            _t6 = _context6.v;
            handleError(res, _t6, "Error getting records by codigo_barras");
          case 4:
            return _context6.a(2);
        }
      }, _callee6, null, [[0, 3]]);
    }));
    function getByCodigoBarras(_x1, _x10) {
      return _getByCodigoBarras.apply(this, arguments);
    }
    return getByCodigoBarras;
  }()
};