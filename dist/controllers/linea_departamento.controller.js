...
var _require = require('../models'),
  Linea_Departamento = _require.Linea_Departamento,
  Departamento = _require.Departamento,
...
module.exports = {
  ...
  createOrUpdate: function () {
    var _createOrUpdate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
      var _req$body, codigo_linea_departamento, codigo_departamento, codigo_linea, estado, usuario_modificacion, fecha_modificacion, newRecord, response, record, now, offset, localDate, _response, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            _req$body = req.body, codigo_linea_departamento = _req$body.codigo_linea_departamento, codigo_departamento = _req$body.codigo_departamento, codigo_linea = _req$body.codigo_linea, estado = _req$body.estado, usuario_modificacion = _req$body.usuario_modificacion, fecha_modificacion = _req$body.fecha_modificacion; // Validar campos obligatorios
          ...
          case 1:
            ...
            _context.n = 2;
            return Linea_Departamento.create({
          ...
          case 2:
            ...
            _context.n = 3;
            return Linea_Departamento.findByPk(newRecord.codigo_linea_departamento, {
              include: [{
                model: Departamento,
                as: 'departamento'
              }, {
          ...
          case 4:
            _context.n = 5;
            return Linea_Departamento.findByPk(codigo_linea_departamento, {
              include: [{
                model: Departamento,
                as: 'departamento'
              }, {
          ...
          case 6:
            // Update fields
            record.codigo_departamento = codigo_departamento !== null && codigo_departamento !== void 0 ? codigo_departamento : record.codigo_departamento;
          ...
          case 7:
            _context.n = 8;
            return Linea_Departamento.findByPk(record.codigo_linea_departamento, {
              include: [{
                model: Departamento,
                as: 'departamento'
              }, {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            _context2.p = 0;
            _context2.n = 1;
            return Linea_Departamento.findAll({
              where: {
                estado: 'A'
              },
              include: [{
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            ...
            id = req.params.id;
            _context3.n = 1;
            return Linea_Departamento.findByPk(id, {
              include: [{
                model: Departamento,
                as: 'departamento'
              }, {
  ...
  getByDepartamento: function () {
    var _getByDepartamento = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
      var codigo_departamento, records, _t4;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.p = _context4.n) {
          ...
          case 2:
            _context4.p = 2;
            _t4 = _context4.v;
            handleError(res, _t4, 'Error getting records by departamento');
          case 3:
            return _context4.a(2);
        }
      }, _callee4, null, [[0, 2]]);
    }));
    function getByDepartamento(_x7, _x8) {
      return _getByDepartamento.apply(this, arguments);
    }
    return getByDepartamento;
  }(),
