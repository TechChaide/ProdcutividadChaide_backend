      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            ...
            _context.n = 2;
            return db.sequelize.query("EXEC [".concat(process.env.DB_NAME2, "].[dbo].[sp_InsertarOrdenEmpleadoPNC] :NUM_ORDEN, :CODIGO_EMP, :UNIDADES_PROD, :TURNO, :CENTRO, :CODIGO, :MAQUINA"), {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            _context2.p = 0;
            _context2.n = 1;
            return Orden_empleado_PNC.findAll({
              include: [],
              order: [["ID", "ASC"]]
            });
          case 1:
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            ...
            id = req.params.id;
            _context3.n = 1;
            return Orden_empleado_PNC.findByPk(id, {
              include: []
            });
          case 1:
            record = _context3.v;
